...
public class menuAlgoritmos {
	...
	public static void main(String[] args) {
		System.out.println("Relação de Algoritmos \n");
		...
		System.out.println("Digite um número para executa-lo: ");
		
		System.out.println("1 - Calcular o volume de uma caixa retângular. ");
